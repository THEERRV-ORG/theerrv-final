...
export const closing = {
  ...
  cta: { label: "Start a conversation", href: "mailto:hello@theerrv.com" },
  secondary: { label: "hello@theerrv.com", href: "mailto:hello@theerrv.com" },
} as const;

export const footer = {
  blurb: "Built on trust. Driven by innovation. Focused on the future.",
  columns: [
    {
      title: "Company",
      links: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Data and automation", href: "#capabilities" },
      ],
    },
  ],
} as const;
