 ...
 * Primary navigation.
 *
 * Two items open a mega panel; the rest are direct links. The panel copy is
 * deliberately shorter than the matching section copy on the page — a menu is
 * scanned, not read, so each entry gets one line that says what the work is
 * rather than the full description it carries in `capabilities`.
 *
 * `href` values are the live single-page anchors. Items marked `pending` have
 * no destination built yet and are rendered as disabled rather than as links,
 * so the bar can carry the final information architecture without shipping
 * dead ends.
 */
...
export type NavMega = {
  eyebrow: string;
  /** Rendered as stacked lines; the last one takes the coral full stop. */
...
export const nav: readonly NavItem[] = [
  { label: "About", href: "#about" },
  {
    ...
    mega: {
      ...
      cta: { label: "Explore all services", href: "#capabilities" },
      items: [
        {
          label: "Product engineering",
          href: "#capabilities",
          body: "Full-stack delivery on .NET and React, from architecture to production.",
        },
        {
          label: "Cloud platforms",
          href: "#capabilities",
          body: "Azure environments built for cost, resilience and scale.",
        },
        {
          label: "Data and ETL",
          href: "#capabilities",
          body: "Pipelines that turn scattered operational data into something usable.",
        },
        {
          label: "Automation",
          href: "#capabilities",
          body: "Removing the manual steps between systems that eat a team's week.",
        },
        {
          label: "AI inside products",
          href: "#capabilities",
          body: "AI features embedded in business applications, not run as experiments.",
        },
        {
          label: "DevOps and observability",
          href: "#capabilities",
          body: "Pipelines and monitoring that make releases routine rather than eventful.",
        },
      ],
    },
  },
  {
    ...
    mega: {
      ...
      cta: { label: "How we work", href: "#modern" },
      items: [
        {
          label: "Business automation",
          href: "#modern",
          body: "Manual handoffs replaced by systems that talk to each other.",
        },
        {
          label: "Analytics",
          href: "#modern",
          body: "Live visibility into how the operation is actually performing.",
        },
        {
          label: "Applied AI",
          href: "#modern",
          body: "Judgement where the rules run out, with a human still in the loop.",
        },
        {
          label: "Enterprise applications",
          href: "#modern",
          body: "The internal platforms an operation runs on, built to be owned.",
        },
      ],
    },
  },
  { label: "Case studies", href: "#case-studies", pending: true },
  { label: "Insights", href: "#insights", pending: true },
...
export const closing = {
  ...
  /**
   * NOTE: "an engineer replies within a business day" is an operational
   * promise, not a marketing line. Keep it only if you will actually hold to
   * it — a missed reply after stating this costs more trust than never
   * having said it. Drop the second sentence if you would rather not commit.
   */
  ...
  secondary: { label: "See how we work", href: "#modern" },
